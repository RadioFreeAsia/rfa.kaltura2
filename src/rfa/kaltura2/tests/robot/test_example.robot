...
#
#  $ bin/test -s rfa.kaltura2 -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src rfa.kaltura2.testing.RFA_KALTURA2_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/rfa/kaltura2/tests/robot/test_example.robot
#
